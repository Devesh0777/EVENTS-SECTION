// Custom cursor with multiple trailing circles and SVG filter
// Based on Codrops Sketch 015; adapted for this page.
...
class Cursor {
  ...
  constructor(DomElems, triggerSelector = 'a, .card') {
    this.DOM.elements = DomElems;
